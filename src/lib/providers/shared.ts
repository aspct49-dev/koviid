...
/**
 * Turns however many players the partner returned into exactly as many seats
 ...
 * come back `unclaimed` with the prize still attached. A board with two players
 * then reads as places going spare, which is both the honest picture and the
 * more persuasive one.
 */
